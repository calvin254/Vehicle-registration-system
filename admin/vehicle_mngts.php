...
<!--start of the main area section-->
    ...
    while($rows=mysqli_fetch_array($run_selectv)){       
                        ?>
<tr>
<!--display the fetched values below-->
<td> 
...
<td><?php echo $rows['email'];  ?></td>
    ...
    <td> 
    <!--approve button-->
     <input type="submit" value="Approve" name="approvereg" class="btnbtn" >  
    </td>
    <td> 
    <!--delete button-->
           <input type="submit" value="Delete Vehicle" name="deletevehicle" class="btnbtn" >
    </td>
                            </tr>
                            <?php 
                            } 
...
<br><br><br>
              <center>
                  <h3>Update Vehicle Registration Status</h3>
                        </center>
                   <br><br>  
                   <label for="Name" class="tlabel" style="margin-left:330px; margin-top:50px;">Vehicle Registration Number</label>
                 <br>
                 <input type="text" value="<?php echo $sessionstatus;  ?>" style="width:400px; margin-left:300px;" name="vnum" readonly><br>  
                
                 <label for="Name" class="tlabel" style="margin-left:330px; margin-top:50px;">Vehicle Plate Number</label>
                 <br>
                 <input type="text" placeholder="Vehicle Plate Number"  style="width:400px; margin-left:300px;" name="vplate"><br>
                
                <div class="buttonsfloat">
                 <button type="submit" name="approve" style="width:20%; float:right;margin-right:240px; margin-bottom:100px;">Activate</button>
                 <button type="submit" name="deactivate" style="width:20%; float:left;margin-left:300px;  margin-bottom:100px;">Deactivate</button>
                </div>
